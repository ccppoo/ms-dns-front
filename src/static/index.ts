const icon = {
  ...
  naverCafe: 'https://cdn.mc-server.kr/static/naver_cafe.png',
  bluemap: 'https://cdn.mc-server.kr/static/bluemap.webp',
  kakaoTalk: 'https://cdn.mc-server.kr/static/kakaotalk.png',
